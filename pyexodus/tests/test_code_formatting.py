...
:copyright:
    Lion Krischer (lionkrischer@gmail.com),
:license:
    MIT License
"""
...
CLEAN_VERSION_NUMBER = bool(_pattern.match(pyexodus.__version__))
...
def test_flake8():
    ...
    pyexodus = os.path.dirname(test_dir)

    # Ignore automatically generated files.
    ignore_files = []
    ignore_files = [os.path.join(pyexodus, _i) for _i in ignore_files]
    files = []
    for dirpath, _, filenames in os.walk(pyexodus):
